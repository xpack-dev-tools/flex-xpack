---
title:  xPack flex v{{releaseVersion}} released
...
flex_version: "{{upstreamVersion}}"
flex_date: "{{customFields.flexReleaseDate}}"

version: "{{releaseVersion}}"
npm_subversion: "1"

download_url: https://github.com/xpack-dev-tools/flex-xpack/releases/tag/v{{releaseVersion}}/
...
The [xPack flex](https://xpack-dev-tools.github.io/flex-xpack/)
...
The full details of installing the **xPack flex**
on various platforms are presented in the [Install Guide](/docs/install/).

## Compliance

The **xPack flex** is based on the official
[flex](https://www.gnu.org/software/flex/) sources.

The current version is based on:

- flex version {frontMatter.flex_version}
