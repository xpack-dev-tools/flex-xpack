...
const config: Config = {
  ...
  tagline: 'A binary distribution of flex',
  ...
  projectName: 'flex-xpack', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/xpack-dev-tools/flex-xpack/edit/xpack/website/',
        ...
        sitemap: {
          ...
          priority: 0.5,
          ignorePatterns: [
            '/flex-xpack/blog/archive/**',
            '/flex-xpack/blog/authors/**',
            '/flex-xpack/blog/tags/**'
          ],
  ...
  headTags: [
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/png',
        href: '/flex-xpack/favicons/favicon-48x48.png',
        sizes: '48x48'
      }
    },
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/svg+xml',
        href: '/flex-xpack/favicons/favicon.svg'
      }
    },
    {
      tagName: 'link',
      attributes: {
        rel: 'shortcut icon',
        href: '/flex-xpack/favicons/favicon.ico'
      }
    },
    {
    ...
    },
    {
      ...
      attributes: {
        rel: 'manifest',
        href: '/flex-xpack/favicons/site.webmanifest'
      }
    }
  ],
  ...
  themeConfig: {
    ...
    metadata: [
      {
        name: 'keywords',
        content: 'xpack, binary, development, tools, reproducibility, flex'
      }
    ],
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/xpack-dev-tools/flex-xpack/',
          position: 'right',
        ...
        },
        {
          ...
          position: 'right',
          href: `https://github.com/xpack-dev-tools/flex-xpack/releases/tag/v${customFields.xpackVersion}`,
        },
      ],
    },
    footer: {
      ...
      links: [
          ...
          items: [
            {
              ...
              href: 'https://github.com/xpack-dev-tools/flex-xpack/discussions',
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub flex-xpack project',
              href: 'https://github.com/xpack-dev-tools/flex-xpack/',
            },
            {
