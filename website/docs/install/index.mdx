...
- <code>xpack-flex-{customField('xpackVersion')}-darwin-x64.tar.gz</code>- <code>xpack-flex-{customField('xpackVersion')}-darwin-arm64.tar.gz</code>
...
- <code>xpack-flex-{customField('xpackVersion')}-linux-x64.tar.gz</code>- <code>xpack-flex-{customField('xpackVersion')}-linux-arm64.tar.gz</code>- <code>xpack-flex-{customField('xpackVersion')}-linux-arm.tar.gz</code>
