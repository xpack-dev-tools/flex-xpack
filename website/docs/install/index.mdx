...
The easiest (and recommended) way to install xPack flex
...
* add <code>@xpack-dev-tools/flex</code> to
  `package.json` as a
  development dependency; this associates a specific version of xPack flex with
...
it is also possible to install xPack flex only globally in
...
In order to access the xPack flex binaries installed in
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/flex/2.6.4-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/flex/2.6.4-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-flex-2.6.4-1-darwin-x64.tar.gz</code></li>
<li><code>xpack-flex-2.6.4-1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/flex/xpack-flex-2.6.4-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/flex
cd ~/Library/xPacks/flex

tar xvf ~/Downloads/xpack-flex-2.6.4-1-darwin-x64.tar.gz
chmod -R -w xpack-flex-2.6.4-1
`} </CodeBlock>
...
<ul>
<li><code>xpack-flex-2.6.4-1-linux-x64.tar.gz</code></li>
<li><code>xpack-flex-2.6.4-1-linux-arm64.tar.gz</code></li>
<li><code>xpack-flex-2.6.4-1-linux-arm.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/flex/xpack-flex-2.6.4-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/flex
cd ~/.local/xPacks/flex

tar xvf ~/Downloads/xpack-flex-2.6.4-1-linux-x64.tar.gz
chmod -R -w xpack-flex-2.6.4-1
`} </CodeBlock>
