...
title: How to get help for flex
...
# How to get help for xPack flex
...
distribution, not to the upstream flex itself
(if you have doubts, use the GitHub Discussions),
or if you have a pertinent suggestion how to enhance the **xPack flex**
