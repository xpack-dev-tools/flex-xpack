...
# How to get help for the xPack flex
...
- Check the [GitHub Discussions](https://github.com/xpack-dev-tools/flex-xpack/discussions) for
similar topics
- Check the [GitHub Issues](https://github.com/xpack-dev-tools/flex-xpack/issues)
tracker and the
...
others, please 
use the [GitHub Discussions](https://github.com/xpack-dev-tools/flex-xpack/discussions)
pages.
