...
title: Information for xPack flex maintainers
...
```sh
bash ~/Work/xpack-dev-tools/flex-xpack.git/build-assets/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-travis-macos.sh
```
...
named like **xPack flex v{ customField('upstreamVersion') }-{ customField('xpackSubversion') }** (mind the dash),
...
- <code>npm dist-tag ls @xpack-dev-tools/flex</code>
- <code>npm dist-tag add @xpack-dev-tools/flex@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/flex</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/flex@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') }</code>
...
- the result is in https://xpack-dev-tools.github.io/flex-xpack/blog/
...
- paste the release name like _**xPack flex v{ customField('upstreamVersion') }-{ customField('xpackSubversion') } released**_
