...
**xPack flex** is a standalone cross-platform (Windows, macOS, GNU/Linux)
binary distribution of flex,
intended for reproducible builds.

<Overview/>

**xPack flex** is an open source project hosted on GitHub as
...
[build scripts](https://github.com/xpack-dev-tools/flex-xpack/tree/xpack/scripts).
...
[`flex-xpack.git/scripts`](https://github.com/xpack-dev-tools/flex-xpack/tree/xpack/scripts/)
