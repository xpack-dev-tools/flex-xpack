...
title: Getting Started with xPack flex
...
![GitHub Repo stars](https://img.shields.io/github/stars/xpack-dev-tools/flex-xpack)

## Overview

**xPack flex** is a standalone
cross-platform (GNU/Linux, macOS)binary distribution of flex,
intended for reproducible builds.

<Overview/>

The open source **xPack flex** project is hosted on GitHub as
[`xpack-dev-tools/flex-xpack`](https://github.com/xpack-dev-tools/flex-xpack);
it provides the platform specific binaries as
[release assets](https://github.com/xpack-dev-tools/flex-xpack/releases).

In addition to the binary archives and the package metadata,
this project also includes the
[build scripts](https://github.com/xpack-dev-tools/flex-xpack/tree/xpack/build-assets/scripts).
...
The main advantages of using the **xPack flex** are:
...
The details of installing the **xPack flex** on various platforms are
presented in the
...
[GitHub Discussions](https://github.com/xpack-dev-tools/flex-xpack/discussions/).
...
[`CHANGELOG.md`](https://github.com/xpack-dev-tools/flex-xpack/blob/xpack/CHANGELOG.md) file.
...
[`flex-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/flex-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/flex-xpack/): It helps others discover our work.
