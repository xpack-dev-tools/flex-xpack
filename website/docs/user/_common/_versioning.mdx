...
upstream {props.upstreamName ? props.upstreamName : 'flex'} project
is a three-number string
such as <code>2.6.4</code>;
...
such as <code>2.6.4-<b>1</b></code>. When
published as an npm package, the version receives
a fifth number,
such as <code>2.6.4-1.<b>1</b></code>.

Since adherence of third-party packages to SemVer is not guaranteed,
it is recommended to avoid referencing the xPack flex dependency via
SemVer expressions
such as <code>^2.6.4-1</code> or <code>~2.6.4-1</code>, and
