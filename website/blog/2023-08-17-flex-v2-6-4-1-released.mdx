...
seo_title: Version 2.6.4-1 released
description: Version 2.6.4-1 is the first release of xPack flex.
keywords:
  - xpack
  - flex
  - release
...
The [xPack GNU flex](https://xpack-dev-tools.github.io/flex-xpack/)
